...
enum DataChange {
  ...
  /// Сменились адрес сервера или ключ. Данные те же, но до этого момента их
  /// было не достать: экраны, застрявшие на «нужен ключ», обязаны попробовать
  /// снова — иначе человек, вписавший верный ключ, решит, что тот не подошёл.
  connection,
}
