          ...
          RowsCard(
            children: [
              ...
              const _MoreRow(
                ...
                title: 'Отчёты',
                subtitle: 'Куда уходят деньги и откуда приходят',
                value: null,
                valueColor: AppColors.textMuted,
                route: '/more/reports',
              ),
    ...
    return SurfaceCard(
      child: Column(
        ...
        children: [
          ...
          // Заметка про валюты убрана: она висела всегда, даже когда валютных
          // долгов нет вовсе, а разбивку по валютам видно на экранах счетов и
          // личных долгов.
        ],
      ),
    );
